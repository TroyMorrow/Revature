...
public class TestSwimmer {
	public static void main(String[] args) {
		...
		int feetTravelled = 80_000;
		System.out.println("So if  the whales went " + feetTravelled + " feet, they" +
		 " would have gone " + Swimmer.convertFromFeetToLeagues(feetTravelled) + " leagues.");
	}
}
