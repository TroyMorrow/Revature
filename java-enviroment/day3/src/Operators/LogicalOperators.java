package Operators;
/*
 * Logical operators are a set of 
 * boolean operators that compare
 * two boolean values/operands
 * based on the value of those 
 * boolean operands, the logical operator
 * will return either true or false
 */
public class LogicalOperators {
	public static void main(String[] args) {
		/*
		 * AND operators will return false
		 * unless both operands are true
		 */
		...
		/*
		 * OR operators will return true
		 * unless both operands are false
		 */
		System.out.println(true | true); //true
